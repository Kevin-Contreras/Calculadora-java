...
public class VentanaPotencia extends JFrame implements ActionListener {
...
public VentanaPotencia(){
		this.setSize(500,190);
		 setLayout(null);
			setTitle("VENTANA DE LA MATRIZ A LA POTENCIA");
...
public void actionPerformed(ActionEvent e){
	if(e.getSource()==tamaño){
		ingresoManualPotencia ingreso = new ingresoManualPotencia(dimension.getText());
		ingreso.setVisible(true);
		this.setVisible(false);
	}else if(e.getSource()==analisis){
		DatosAnaliticosPotencia analisisn = new DatosAnaliticosPotencia(dimension.getText());
