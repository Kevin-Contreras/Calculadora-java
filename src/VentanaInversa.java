...
public class VentanaInversa extends JFrame implements ActionListener {
...
public VentanaInversa(){
		this.setSize(500,190);
		 setLayout(null);
			setTitle("VENTANA DE LA MATRIZ INVERSA");
...
public void actionPerformed(ActionEvent e){
	if(e.getSource()==tamaño){
		ingresoManualInversa ingreso = new ingresoManualInversa(dimension.getText());
		ingreso.setVisible(true);
		this.setVisible(false);
	}else if(e.getSource()==analisis){
		AnalisisInversa analisisn = new AnalisisInversa(dimension.getText());
